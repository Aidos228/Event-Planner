...
def load_csv_records(csv_filename):
    ...
    records = []
    try:
        instance_csv_path = os.path.join('instance', csv_filename)
...
def venues():
    ...
    if request.args.get('event_type'):
        ...
        query = query.filter(Venue.event_types.contains(event_type))
...
def user_profile(user_id):
    ...
    return render_template('user_profile.html', user=user, upcoming_bookings=upcoming_bookings, past_bookings=past_bookings)
...
def add_sample_data():
    ...
    venues_data = [
        ...
        },
        {
            ...
            'event_types': 'wedding,tusau_keser,kudalyk,corporate'
        },
        {
        ...
        },
        {
            ...
            'event_types': 'wedding,corporate,tusau_keser,kudalyk'
        }
    ]
